...
5. [状态对象：数据库的替代者](#状态对象：数据库的替代者)
   ...
   - [状态管理中间件](#状态管理中间件)
   - [状态设计的难点](#状态设计的难点)
6. [使用聚合(Aggregate)来设计类库](#使用聚合(Aggregate)来设计类库)
7. [CQRS架构](#CQRS架构)
