...
jQuery Mobile 是 jQuery 的移动版本，懂基本的 jQuery 知识，会简单的 html + css 就可以完成很多复杂的功能。
...
5、设置data-mini，使按钮变小。注意data-mini和data-inline的区别
...
<ul>
<li><a ref="#" class="ui-btn-active">One</a></li>
<li><a ref="#">Two</a></li>
...
<input name="textinput-f" id="textinput-f" placeholder="Text input" value="" type="text">
<div data-role="controlgroup">
...
- [http://www.phonegap100.com/article-73-1.html](http://www.phonegap100.com/article-73-1.html)
- [http://bbs.phonegap100.com/thread-111-1-1.html](http://bbs.phonegap100.com/thread-111-1-1.html)
