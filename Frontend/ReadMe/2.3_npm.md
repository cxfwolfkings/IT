...
[nrm](https://www.npmjs.com/package/nrm) 是一个管理切换 npm registries 的命令行工具，由于各个地区不同的网络环境，以及镜像同步不全量的问题，在使用淘宝源时仍有可能遇到一次错误，使用 nrm 可以迅速在各个安装源之间进行切换，而且它还带有测速功能，这能让我们很方便地挑选出最适合自己使用的安装源。
