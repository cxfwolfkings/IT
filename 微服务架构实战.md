...
docker run --privileged --name keepalived_master keepavled_nginx:v1 /usr/sbin/init
docker run --privileged --name keepalived_salve keepavled_nginx:v1 /usr/sbin/init
```
