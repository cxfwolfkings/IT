...
namespace Com.Colin.Win.Customized
{
    public partial class DateTimeControl : UserControl
    {
        ...
        [Browsable(true), Category("设置日期"), Description("设置阳历的日期，其默认值为系统当前日期")] // 在“属性”窗口中显示 Date 属性
        ...
        {
            Graphics TitG = this.CreateGraphics(); // 创建 Graphics 类对象
        ...
        public void GetLunarCalendar(DateTime dtDay, out string embolism, out string Lunardata)
        {
