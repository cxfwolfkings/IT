...
namespace Com.Colin.UI.Controllers
{
    ...
    public class MenuAdminController : Controller
    {
        ...
        public async Task<ActionResult> Details(int? id)
        {
            ...
            Menu2 menu = await db.Menus.FindAsync(id);
            if (menu == null)
            {
                return HttpNotFound();
            }
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,MenuCardId,Text,Price,Active,Order,Type,Day")] Menu2 menu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,MenuCardId,Text,Price,Active,Order,Type,Day")] Menu2 menu)
        {
            if (ModelState.IsValid)
            {
