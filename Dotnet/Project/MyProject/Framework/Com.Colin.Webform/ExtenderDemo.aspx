<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExtenderDemo.aspx.cs" Inherits="Com.Colin.Web.ExtenderDemo" %>
...
<body>
  ...
  <div>
    <asp:UpdatePanel runat="server" ID="updatePanel1">
      <ContentTemplate>
        <span style="display: inline-block; padding: 2px;">My favorite color is:</span>
