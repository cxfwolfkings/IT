...
2. 生成缩略图
   ...
   ![x](./Resource/image-thumbnail.png)
...
4. 旋转和翻转
   ...
   ![x](./Resource/image-rotate.png)

   ![x](./Resource/image-transpose.png)
